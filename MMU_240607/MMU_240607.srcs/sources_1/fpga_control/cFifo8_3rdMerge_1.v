...
//  Description: Match the storation delay and the 
//               adderMerge64 delay in the 3rdMerge.
//-----------------------------------------------
`timescale 1ns / 1ps

module cFifo8_3rdMerge_1(
    // From Last
    input           i_drive,
    output          o_free,
    // To Next
...
(* dont_touch="true" *)delay2Unit outdelay0 (.inR(o_fire_8), .outR(w_driveNext), .rst(rst));
