...
input [32:0] i_data0_32,i_data1_32;
input i_freeNext;
input rst;

output o_free0, o_free1;
output o_driveNext;
output [32:0] o_data_32;
...
wire [32:0] w_data0_32,w_data1_32;
reg [32:0] r_data0_32,r_data1_32;
...
assign o_data_32 = (w_firstReq == 1'b1) ? w_data0_32 :
			((w_secondReq == 1'b1) ? w_data1_32 : 33'b0);
