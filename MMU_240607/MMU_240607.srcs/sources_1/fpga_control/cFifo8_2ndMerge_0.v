...
(* dont_touch="true" *)delay4Unit outdelay0 (.inR(o_fire_8[7]), .outR(w_driveNext), .rst(rst));
(* dont_touch="true" *)delay4Unit outdelay1 (.inR(w_driveNext), .outR(o_driveNext), .rst(rst));
endmodule
