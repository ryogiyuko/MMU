...
HD_PWD='D:/Xilinx/Verilog/MMU_240607/MMU_240607.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cMutexMerge3_1b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cMutexMerge3_1b.tcl
